...
## Аудит
В кластере с Deckhouse всегда присутствует политика для логирования событий, связанных с операциями создания, удаления и изменения:
...
За применение дополнительных политик отвечает параметр [конфигурации](configuration.html) `auditPolicyEnabled`.
