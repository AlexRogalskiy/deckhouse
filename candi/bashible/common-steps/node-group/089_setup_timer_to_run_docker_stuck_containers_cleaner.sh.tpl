...
function main() {
  ...
  echo "---"
  echo "Start check docker containers are in stuck. "
  echo "Use '$image_pattern' for match container image."
  echo "A container will be considered stuck if it is mentioned $failed_container_kills_times times in dockerd log"
  echo "Logs will be gotten for last $log_period_minutes minutes"
  echo "---"
